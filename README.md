...
2. Update the GoHighLevel credentials
3. Replace Location ID and Calendar ID with your values
4. Activate the workflow
5. Copy the webhook URL
6. Configure the webhook URL in your VAPI assistant
...
1. **Manual Test via n8n:**
   - Click the "Execute Workflow" button
   - Send a test webhook with sample data

2. **Test Payload Example:**
```json
{
  "message": {
    "toolCalls": [
